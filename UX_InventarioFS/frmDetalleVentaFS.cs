...
{
    public partial class frmDetalleVentaFS : Form
    {
        public List<DetalleOrdenVentaFS> listaConsultarDetalleVentaFS { get; set; }
        public frmDetalleVentaFS()
        {
            InitializeComponent();
            CargarListado();
        }
        ...
        private void CargarListado()
        {
            try
            {
                List<DetalleOrdenVentaFS> lstaresultado = Logica.ConsultarDetalleOrdenVentaFS(new DetalleOrdenVentaFS());
                ...
                foreach (DetalleOrdenVentaFS item in lstaresultado)
                {
        ...
        private void txt_Buscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                List<DetalleOrdenVentaFS> filtrado = listaConsultarDetalleVentaFS;
                ...
                if (filtrado != null && filtrado.Count() > 0 && txt_Buscar.Text.Trim().Length > 0)
                {
                    ...
                    foreach (DetalleOrdenVentaFS item in filtrado)
                    {
                        dt.Rows.Add(item.DetalleID,
                        item.VentaID,
                        item.ProductoID,
        ...
        {
            DetalleOrdenVentaFS u = new DetalleOrdenVentaFS
            {
                //DetalleID= Convert.ToInt32(txt_id.Text.Trim()),
                VentaID = Convert.ToInt32(txt_ordenid.Text.Trim()),
            ...
            Logica.AgregarDetalleOrdenVentaFS(u);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Logica.ModificarDetalleOrdenVentaFS(u);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Logica.EliminarDetalleOrdenVentaFS(u);
